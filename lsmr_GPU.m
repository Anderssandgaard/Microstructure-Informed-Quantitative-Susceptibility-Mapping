   ...
   = lsmr_GPU(A, b, lambda, atol, btol, conlim, itnlim, localSize, show,params)
...
%-----------------------------------------------------------------------
  ...
  if localSize > 0
    ...
    localV = zeros(n, min([localSize minDim]),'like',b);
  end
